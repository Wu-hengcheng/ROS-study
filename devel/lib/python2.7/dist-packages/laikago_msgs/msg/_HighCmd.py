...
"""autogenerated by genpy from laikago_msgs/HighCmd.msg. Do not edit."""
import codecs
import sys
...
class HighCmd(genpy.Message):
  _md5sum = "2dd27d670ca407541b0dd80079b1b2f6"
  _type = "laikago_msgs/HighCmd"
...
uint8 g
uint8 b"""
  __slots__ = ['levelFlag','mode','forwardSpeed','sideSpeed','rotateSpeed','bodyHeight','footRaiseHeight','yaw','pitch','roll','led','wirelessRemote','crc']
  _slot_types = ['uint8','uint8','float32','float32','float32','float32','float32','float32','float32','float32','laikago_msgs/LED[4]','uint8[40]','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       levelFlag,mode,forwardSpeed,sideSpeed,rotateSpeed,bodyHeight,footRaiseHeight,yaw,pitch,roll,led,wirelessRemote,crc
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2B8f().pack(_x.levelFlag, _x.mode, _x.forwardSpeed, _x.sideSpeed, _x.rotateSpeed, _x.bodyHeight, _x.footRaiseHeight, _x.yaw, _x.pitch, _x.roll))
      if len(self.led) != 4:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.levelFlag, _x.mode, _x.forwardSpeed, _x.sideSpeed, _x.rotateSpeed, _x.bodyHeight, _x.footRaiseHeight, _x.yaw, _x.pitch, _x.roll,) = _get_struct_2B8f().unpack(str[start:end])
      self.led = []
      for i in range(0, 4):
...
def _get_struct_I():
    ...
    return _struct_I
_struct_2B8f = None
def _get_struct_2B8f():
    global _struct_2B8f
    if _struct_2B8f is None:
        _struct_2B8f = struct.Struct("<2B8f")
    return _struct_2B8f
_struct_3B = None
def _get_struct_3B():
    global _struct_3B
